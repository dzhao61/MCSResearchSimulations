...
Profile: `focused`. Null replicates per configuration: `1`. JIDT-shuffled replicates per configuration: `0`. JIDT shuffles per p-value: `20`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0.1 | 0.2333 | 0.1 | 0.1667 | 0.1 |  | 0 | 0 | 0 | 0 |  |
| 0.05 | 0.125 | 0.05 | 0.05 | 0.05 |  | 0 | 0 | 0 | 0 |  |
...
| 2x2_N50_mild | 0 | 0 | 0 |  | 0.05 | 0.05 |
| 2x2_N50_strong | 0 | 0 | 0 |  | 0.05 | 0.05 |
| 3x3_N50_balanced | 0 | 0 | 0 |  | 0.05 | 0.05 |
| 3x3_N50_mild | 0 | 0 | 0 |  | 0.05 | 0.05 |

## Runtime
Median per-table times: saddlepoint/exact `0.001385s`, nominal/dynamic chi-squared `5.596e-05s`, low-shuffle JIDT `nans`.
