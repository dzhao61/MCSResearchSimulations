...
Exact simulated configurations: `25`.
...
- [Balanced/mild](case_sheets/POWER_balanced_mild.md)
- [Sparse](case_sheets/POWER_sparse.md)
- [Extreme rare](case_sheets/POWER_extreme_rare.md)
