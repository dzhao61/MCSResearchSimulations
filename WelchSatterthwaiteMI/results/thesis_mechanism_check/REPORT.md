# Explanatory follow-up to the thesis review

This is a post-review diagnostic study, separate from the frozen confirmatory run.
...
| configuration_id | pair_id | shape | profile | n_p | n_q | target_mi_p | target_mi_q | section | population | mi | v | tau2 | mean_vhat | var_vhat | mean_vhat_over_v | n_var_ihat_over_v | population_first_order_df | empirical_moment_df | median_plugin_df | first_order_var_ratio |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| config_f67e74127a56dc37 | pair_fb6e4c79f03f599b | 3x3 | different_skew | 100 | 100 | 0.02 | 0.02 | main | p | 0.02 | 0.044747 | 0.23204 | 0.078524 | 0.0025455 | 1.7548 | 1.5154 | 1.7258 | 4.8446 | 3.1437 | 1.097 |
| config_f67e74127a56dc37 | pair_fb6e4c79f03f599b | 3x3 | different_skew | 100 | 100 | 0.02 | 0.02 | main | q | 0.02 | 0.049643 | 0.32675 | 0.080714 | 0.0034541 | 1.6259 | 1.3609 | 1.5084 | 3.7721 | 2.429 | 1.0571 |
| config_1b6b2afc5ccb1291 | pair_fb6e4c79f03f599b | 3x3 | different_skew | 1000 | 1000 | 0.02 | 0.02 | main | p | 0.02 | 0.044747 | 0.23204 | 0.048827 | 0.00023241 | 1.0912 | 1.027 | 17.258 | 20.516 | 18.816 | 1.0016 |
| config_1b6b2afc5ccb1291 | pair_fb6e4c79f03f599b | 3x3 | different_skew | 1000 | 1000 | 0.02 | 0.02 | main | q | 0.02 | 0.049643 | 0.32675 | 0.053549 | 0.00032652 | 1.0787 | 1.0304 | 15.084 | 17.564 | 16.52 | 0.99927 |
...
| profile | method | regimes | below | inside | above | minimum_valid |
| --- | --- | --- | --- | --- | --- | --- |
| uniform | normal_wald | 36 | 10 | 18 | 8 | 0 |
| uniform | expanded_welch | 36 | 19 | 16 | 1 | 0 |
| same_skew | normal_wald | 36 | 14 | 15 | 7 | 0 |
| same_skew | expanded_welch | 36 | 25 | 11 | 0 | 0 |
| different_skew | normal_wald | 36 | 9 | 16 | 11 | 0 |
| different_skew | expanded_welch | 36 | 19 | 13 | 4 | 0 |
