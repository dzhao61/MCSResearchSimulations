...
| MI settings by vertical regime | strong, $n_Q:n_P=2:1$: $M\approx0.01113$, $I(P)\approx0.002227$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=5:1$: $M\approx0.01113$, $I(P)\approx0.002227$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=10:1$: $M\approx0.01113$, $I(P)\approx0.002227$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=2:1$: $M\approx0.002633$, $I(P)\approx0.0005266$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=5:1$: $M\approx0.002633$, $I(P)\approx0.0005266$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=10:1$: $M\approx0.002633$, $I(P)\approx0.0005266$, $e$ values $\{0, 0.1, 0.4\}$ |
| Horizontal axis within each graph | Scaled MI difference $e$, from 0 to 0.60; the corresponding absolute difference is $eM$ nats |
| Vertical axis within each graph | Unconditional rejection rate from 0 to 1; an invalid result counts as a non-rejection |
| Methods | {Normal Wald, Expanded Welch} |
| Test and significance level | Two-sided test of $H_0:I(P)=I(Q)$ at $\alpha=0.05$ |
...
| Vertical graph regime specifications (rows) | $\{\text{strong}, n_Q:n_P=2:1;\ \text{strong}, 5:1;\ \text{strong}, 10:1;\ \text{ultra}, 2:1;\ \text{ultra}, 5:1;\ \text{ultra}, 10:1\}$ |
| Resulting sample sizes | ratio 2:1: $\{(5,10),(10,20),(20,40),(50,100),(100,200)\}$; ratio 5:1: $\{(5,25),(10,50),(20,100),(50,250),(100,500)\}$; ratio 10:1: $\{(5,50),(10,100),(20,200),(50,500),(100,1000)\}$, where each pair is $(n_P,n_Q)$ |
| MI settings by vertical regime | strong, $n_Q:n_P=2:1$: $M\approx0.1922$, $I(P)\approx0.03844$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=5:1$: $M\approx0.1922$, $I(P)\approx0.03844$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=10:1$: $M\approx0.1922$, $I(P)\approx0.03844$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=2:1$: $M\approx0.113$, $I(P)\approx0.0226$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=5:1$: $M\approx0.113$, $I(P)\approx0.0226$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=10:1$: $M\approx0.113$, $I(P)\approx0.0226$, $e$ values $\{0, 0.1, 0.4\}$ |
| Horizontal axis within each graph | Scaled MI difference $e$, from 0 to 0.60; the corresponding absolute difference is $eM$ nats |
| Vertical axis within each graph | Unconditional rejection rate from 0 to 1; an invalid result counts as a non-rejection |
| Methods | {Normal Wald, Expanded Welch} |
| Test and significance level | Two-sided test of $H_0:I(P)=I(Q)$ at $\alpha=0.05$ |
...
| Vertical graph regime specifications (rows) | $\{\text{strong}, n_Q:n_P=2:1;\ \text{strong}, 5:1;\ \text{strong}, 10:1;\ \text{ultra}, 2:1;\ \text{ultra}, 5:1;\ \text{ultra}, 10:1\}$ |
| Resulting sample sizes | ratio 2:1: $\{(5,10),(10,20),(20,40),(50,100),(100,200)\}$; ratio 5:1: $\{(5,25),(10,50),(20,100),(50,250),(100,500)\}$; ratio 10:1: $\{(5,50),(10,100),(20,200),(50,500),(100,1000)\}$, where each pair is $(n_P,n_Q)$ |
| MI settings by vertical regime | strong, $n_Q:n_P=2:1$: $M\approx0.336$, $I(P)\approx0.06721$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=5:1$: $M\approx0.336$, $I(P)\approx0.06721$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=10:1$: $M\approx0.336$, $I(P)\approx0.06721$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=2:1$: $M\approx0.1945$, $I(P)\approx0.0389$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=5:1$: $M\approx0.1945$, $I(P)\approx0.0389$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=10:1$: $M\approx0.1945$, $I(P)\approx0.0389$, $e$ values $\{0, 0.1, 0.4\}$ |
| Horizontal axis within each graph | Scaled MI difference $e$, from 0 to 0.60; the corresponding absolute difference is $eM$ nats |
| Vertical axis within each graph | Unconditional rejection rate from 0 to 1; an invalid result counts as a non-rejection |
| Methods | {Normal Wald, Expanded Welch} |
| Test and significance level | Two-sided test of $H_0:I(P)=I(Q)$ at $\alpha=0.05$ |
...
| Vertical graph regime specifications (rows) | $\{\text{strong}, n_Q:n_P=2:1;\ \text{strong}, 5:1;\ \text{strong}, 10:1;\ \text{ultra}, 2:1;\ \text{ultra}, 5:1;\ \text{ultra}, 10:1\}$ |
| Resulting sample sizes | ratio 2:1: $\{(5,10),(10,20),(20,40),(50,100),(100,200)\}$; ratio 5:1: $\{(5,25),(10,50),(20,100),(50,250),(100,500)\}$; ratio 10:1: $\{(5,50),(10,100),(20,200),(50,500),(100,1000)\}$, where each pair is $(n_P,n_Q)$ |
| MI settings by vertical regime | strong, $n_Q:n_P=2:1$: $M\approx0.4029$, $I(P)\approx0.08058$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=5:1$: $M\approx0.4029$, $I(P)\approx0.08058$, $e$ values $\{0, 0.1, 0.4\}$<br>strong, $n_Q:n_P=10:1$: $M\approx0.4029$, $I(P)\approx0.08058$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=2:1$: $M\approx0.2309$, $I(P)\approx0.04618$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=5:1$: $M\approx0.2309$, $I(P)\approx0.04618$, $e$ values $\{0, 0.1, 0.4\}$<br>ultra, $n_Q:n_P=10:1$: $M\approx0.2309$, $I(P)\approx0.04618$, $e$ values $\{0, 0.1, 0.4\}$ |
| Horizontal axis within each graph | Scaled MI difference $e$, from 0 to 0.60; the corresponding absolute difference is $eM$ nats |
| Vertical axis within each graph | Unconditional rejection rate from 0 to 1; an invalid result counts as a non-rejection |
| Methods | {Normal Wald, Expanded Welch} |
| Test and significance level | Two-sided test of $H_0:I(P)=I(Q)$ at $\alpha=0.05$ |
