...
multi-stage sampling and discuss excessive conservatism at small effective
degrees of freedom. \citet{kauermann2001} examine the variability and
efficiency of sandwich covariance estimation. Related adjustments and practical
guidance are given by \citet{fay2001} and \citet{imbens2016}. These are close
...
approximation. \citet{roulston1999} derive entropy and MI error estimates
using error propagation and examine them numerically. \citet{hutter2002}
...
\end{equation}
as its effective degrees of freedom \citep{hutcheson1970}. Thus each component
