...
\section{Overall calibration and a mechanism check}
...
deviation gave 0.0551, while using the population first-order standard
deviation gave 0.0976. The first-order approximation is therefore imperfect
in both the estimated standard error and the numerator distribution. This
supports the simpler interpretation that changing only the reference
distribution cannot correct every finite-sample error. Full pilot and
ablation results are retained in the experiment supplement.
