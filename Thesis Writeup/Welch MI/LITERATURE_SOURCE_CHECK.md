...
| `hutcheson1970` | Elsevier DOI record, *Journal of Theoretical Biology* 29(1), pp. 151--154; formula cross-checked against the U.S. EPA technical manual reproduction | Shannon-diversity Student comparison with component df (n_i). | Reclassified as a direct information-theoretic Welch predecessor. Its MI analogue is now a named supplementary baseline; it remains distinct from the expanded MI-variance sensitivity. |
