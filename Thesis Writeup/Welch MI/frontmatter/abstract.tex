...
A supplementary post-protocol mechanism study finds that estimated standard errors can
exceed actual sampling variability. Near independence, local expansions give
component degrees of freedom approximately equal to sample size times MI,
while omitted quadratic terms can invalidate that first-order moment match.
Simpler Welch ablations distinguish the additional effect of differentiating
the complete variance functional.
